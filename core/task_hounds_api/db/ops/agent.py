...
def seed_default_agents(path: Path | None = None) -> None:
    ...
    rows = [
        (
            ...
            os.environ.get("POWER_TEAMS_MANAGER_OPENCODE_AGENT", "Sisyphus - ultraworker"),
        ),
        (
        ...
        (
            ...
            os.environ.get("POWER_TEAMS_REVIEWER_OPENCODE_AGENT", "Sisyphus - ultraworker"),
        ),
        (
            "chat_0001", "chat", "chat",
            ...
            os.environ.get("POWER_TEAMS_CHAT_OPENCODE_AGENT", "Sisyphus - ultraworker"),
        ),
    ]
    with connect(path) as db:
        db.executemany(
