...
inside `tests/` because the `tests/` directory is not a Python
...
Both `tests/test_ui_backend_contract.py` and
`tests/test_phase4_v2.py` import from this module. Adding a new
